        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[1.15fr_0.85fr] gap-16 items-center">
          ...
          <div className="space-y-7 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 font-mono text-xs md:text-sm uppercase tracking-[0.15em] text-[#d4af37]">
              ...
              status: open to work — available jun 2026
            </div>
            ...
            <p className="font-display italic text-xl md:text-2xl text-[#93897a] max-w-xl mx-auto lg:mx-0">
              Full-stack developer, Manila-based, allergic to double-bookings.
            </p>

            <p className="text-base md:text-lg text-[#93897a] leading-relaxed max-w-xl mx-auto lg:mx-0">
              I&apos;m a Computer Science student at Emilio Aguinaldo College who builds
              with React, Next.js, and Node — and who&apos;d rather write the
              constraint-solving algorithm than fill out the schedule by hand. I sweat
              the parts nobody sees: race conditions, edge cases, test case #4,817.
            </p>
          ...
          {/* Signature visual: the scheduling grid resolving conflicts in real time */}
          <div className="flex flex-col items-center gap-4">
            <ScheduleGrid
              cols={8}
              rows={5}
              className="w-[240px] sm:w-[280px] lg:w-full lg:max-w-[320px]"
            />
            <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-[#93897a] text-center">
              // zero-conflict scheduling, visualized
            </p>
          </div>
        </div>
      </main>
